            ...
            <form name="frm" id="frm" action="{{url('incidencia/reporte/procesareficiencia')}}">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                	...
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="text" name="registroe" class="input-sm form-control" required >
                        
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label for="" class="control-label">Costo Esperado</label>
                        <input type="text" name="costoe" class="input-sm form-control" required >
                    </div>
