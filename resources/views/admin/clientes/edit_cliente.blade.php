...
<div class="modal-body" ng-controller="ClientesController">
    <form id="frmcliente" name="frmcliente" class="form-horizontal" novalidate="" ng-submit="editarCliente()">
        {{ method_field('PUT') }}
        {{ csrf_field()  }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="dni_ruc" name="dni_ruc" placeholder="RUC o DNI"  ng-model="cliente.dni_ruc" ng-required="true">
